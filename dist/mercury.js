...
var STRIP_OUTPUT_TAGS = ['title', 'script', 'noscript', 'link', 'style']; // cleanAttributes
...
var difflib = createCommonjsModule(function (module, exports) {
  ...
  */
  (function () {
    ...
    _arrayCmp = function _arrayCmp(a, b) {
      ...
      for (i = _i = 0, _ref1 = min(la, lb); _ref1 >= 0 ? _i < _ref1 : _i > _ref1; i = _ref1 >= 0 ? ++_i : --_i) {
        if (a[i] < b[i]) {
          return -1;
        }
    ...
    getCloseMatches = function getCloseMatches(word, possibilities, n, cutoff) {
      var result;
      var s;
      var score;
      var x;
      ...
      Differ.prototype._dump = function (tag, x, lo, hi) {
        ...
        */
        ...
        for (i = _i = lo; lo <= hi ? _i < hi : _i > hi; i = lo <= hi ? ++_i : --_i) {
          _results.push("".concat(tag, " ").concat(x[i]));
        }
    ...
    IS_LINE_JUNK = function IS_LINE_JUNK(line, pat) {
      if (pat == null) {
        pat = /^\s*#?\s*$/;
      }
      /*
    ...
    IS_CHARACTER_JUNK = function IS_CHARACTER_JUNK(ch, ws) {
      if (ws == null) {
        ws = ' \t';
      }
      /*
    ...
    unifiedDiff = function unifiedDiff(a, b, _arg) {
      var file1Range;
      var file2Range;
      var first;
      var fromdate;
    ...
    contextDiff = function contextDiff(a, b, _arg) {
      var file1Range;
      var file2Range;
      var first;
      var fromdate;
    ...
    ndiff = function ndiff(a, b, linejunk, charjunk) {
      if (charjunk == null) {
...
var difflib_1 = difflib._arrayCmp;
var difflib_2 = difflib.SequenceMatcher;
var difflib_3 = difflib.getCloseMatches;
var difflib_4 = difflib._countLeading;
var difflib_5 = difflib.Differ;
var difflib_6 = difflib.IS_LINE_JUNK;
var difflib_7 = difflib.IS_CHARACTER_JUNK;
var difflib_8 = difflib._formatRangeUnified;
var difflib_9 = difflib.unifiedDiff;
var difflib_10 = difflib._formatRangeContext;
var difflib_11 = difflib.contextDiff;
var difflib_12 = difflib.ndiff;
var difflib_13 = difflib.restore;
